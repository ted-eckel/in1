...
import { toggleKeepModal, setUploadFolderId } from '../actions/AppActions'
import { uploadNotes } from '../actions/NoteActions'
...
export default class KeepModal extends Component {
  constructor(props) {
    super(props)
  }
